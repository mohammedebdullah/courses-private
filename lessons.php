...
// Get full absolute URL for logo with cache-busting parameter
const logoUrl = window.location.origin + window.location.pathname.substring(0, window.location.pathname.lastIndexOf('/')) + '/assets/img/dark.png?v=<?= time() ?>';
