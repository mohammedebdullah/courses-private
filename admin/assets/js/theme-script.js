...
<div class="sidebar-contact ">
    ...
    <div class="themecard-body offcanvas-body">
        <div class="accordion accordion-customicon1 accordions-items-seperate" id="settingtheme">
            <!-- Select Layouts block removed: commented out to disable layout options -->
            <!--
                ...
                <div id="topbarsetting" class="accordion-collapse collapse show"	>
                    <div class="accordion-body pb-1 px-0 py-3 border-top">
                       ...
                       <div class="d-flex align-items-center flex-wrap">
                            ...
                            <div class="theme-colorselect theme-colorselect-rounded mb-3 me-3 mt-0">
                ...
                <div id="sidebarcolor" class="accordion-collapse collapse show">
                    <div class="accordion-body px-0 py-3 border-top">
                       ...
                       <div class="d-flex align-items-center">
                            ...
                            <div class="theme-colorselect mt-0 mb-2 me-3">
                ...
                <div id="modesetting" class="accordion-collapse collapse show">
                    <div class="accordion-body px-0 py3 border-top">
                       <div class="d-flex align-items-center">
                            ...
                            <div class="theme-mode flex-fill w-100 text-center me-3">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function handleInputChange() {
            ...
            const layoutEl = document.querySelector('input[name="LayoutTheme"]:checked');
            const widthEl = document.querySelector('input[name="width"]:checked');

            const theme = themeEl ? themeEl.value : (localStorage.getItem('theme') || 'light');
            const layout = layoutEl ? layoutEl.value : (localStorage.getItem('layout') || 'default');
            const width = widthEl ? widthEl.value : (localStorage.getItem('width') || 'fluid');
            ...
            color = colorEl ? colorEl.value : (localStorage.getItem('color') || 'primary');

            const sidebarEl = document.querySelector('input[name="sidebar"]:checked');
            sidebarTheme = sidebarEl ? sidebarEl.value : (localStorage.getItem('sidebarTheme') || 'light');

            const topbarEl = document.querySelector('input[name="topbar"]:checked');
            topbar = topbarEl ? topbarEl.value : (localStorage.getItem('topbar') || 'white');
        ...
        function resetThemeAndSidebarThemeAndColorAndBg() {
            ...
            const elLightTheme = document.getElementById('lightTheme');
            if (elLightTheme) elLightTheme.checked = true;
            const elLightSidebar = document.getElementById('lightSidebar');
            if (elLightSidebar) elLightSidebar.checked = true;
            const elPrimaryColor = document.getElementById('primaryColor');
            if (elPrimaryColor) elPrimaryColor.checked = true;
            const elDefaultLayout = document.getElementById('defaultLayout');
            if (elDefaultLayout) elDefaultLayout.checked = true;
            const elWhiteTopbar = document.getElementById('whiteTopbar');
            if (elWhiteTopbar) elWhiteTopbar.checked = true;
            const elFluidWidth = document.getElementById('fluidWidth');
            if (elFluidWidth) elFluidWidth.checked = true;
